...
public class Android_MainScreen extends MainScreen {

    static {
        КНОПКА_ОК_ОКНО_ВЫБОРА_РЕГИОНА_1Й_ЗАПУСК = "id:limehd.ru.lite:id/button_ok";
    ...
    public Android_MainScreen(RemoteWebDriver driver) {
        super(driver);
    }
}